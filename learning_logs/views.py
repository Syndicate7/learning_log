...
#from django.core.urlresolvers import reverse ---V (Изменилось...)
...
def new_topic(request):
	...
	if request.method != 'POST':
		...
		if form.is_valid():
			...
			new_topic.save()
			return HttpResponseRedirect(reverse('learning_logs:topics'))#Возвращение обратно к списку тем.
...
def new_entry(request, topic_id):
	...
	if request.method != 'POST':
		...
		if form.is_valid():
			...
			new_entry.save() # Запись сохраняется в базе данных с правильной ассоциированной темой.
